    ...
    "@graph": [
      {
        ...
        "knowsAbout": [
          "Dishwasher Repair",
          "Dishwasher Drainage Diagnostics",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.appliancerepairknights.com/services/dishwasher-repair#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
    ...
    <section class="py-16 max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12">
      <div class="lg:col-span-8 space-y-12">
        ...
        <div class="h-64 md:h-96 bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center border border-bordercolor">
          <img src="../img/open-dishwasher-repair.webp" alt="Dishwasher Diagnostic and Repair Details" title="Reliable Dishwasher Repair & Pump Diagnostics" width="798" height="448" loading="lazy" decoding="async" class="object-cover w-full h-full">
        </div>
    ...
    <section class="bg-slate-50 border-y border-bordercolor py-16">
      <div class="max-w-4xl mx-auto px-4 space-y-8">
        <div class="text-center space-y-2">
          ...
          <h2 class="text-2xl sm:text-3xl font-heading font-bold text-primary">Dishwasher Repair FAQ – GTA</h2>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white border border-bordercolor rounded-xl overflow-hidden shadow-sm">
            <button class="w-full px-6 py-5 text-left font-semibold text-primary flex justify-between items-center hover:text-accent focus:outline-none transition-colors" onclick="toggleFaq(this)">
              <span>Q. How much does dishwasher repair cost in the GTA?</span>
            ...
            <div class="hidden px-6 pb-5 text-xs md:text-sm text-slate-600 leading-relaxed">
              Dishwasher repair costs depend on the appliance brand, model, and failed component. Common repairs may involve the drain pump, wash motor, inlet valve, door latch, heating element, or control system. A technician can diagnose the problem and explain the expected repair cost before proceeding. We can provide more specific pricing once your dishwasher repair needs in the GTA have been assessed.
            </div>
          </div>
          ...
          <div class="bg-white border border-bordercolor rounded-xl overflow-hidden shadow-sm">
            <button class="w-full px-6 py-5 text-left font-semibold text-primary flex justify-between items-center hover:text-accent focus:outline-none transition-colors" onclick="toggleFaq(this)">
              <span>Q. Why is my dishwasher not draining water?</span>
              <svg class="w-5 h-5 text-slate-400 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="hidden px-6 pb-5 text-xs md:text-sm text-slate-600 leading-relaxed">
          ...
          <div class="bg-white border border-bordercolor rounded-xl overflow-hidden shadow-sm">
            <button class="w-full px-6 py-5 text-left font-semibold text-primary flex justify-between items-center hover:text-accent focus:outline-none transition-colors" onclick="toggleFaq(this)">
              <span>Q. Why are my dishes coming out dirty after a wash cycle?</span>
              <svg class="w-5 h-5 text-slate-400 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="hidden px-6 pb-5 text-xs md:text-sm text-slate-600 leading-relaxed">
              Poor cleaning can result from blocked spray arms, a dirty filter, hard-water buildup, insufficient water flow, incorrect detergent use, or a problem with the wash motor. Cleaning the filter and spray arms is a good first step. If performance does not improve, a GTA dishwasher repair technician can check the appliance for a deeper mechanical or water-flow problem.
          ...
          <div class="bg-white border border-bordercolor rounded-xl overflow-hidden shadow-sm">
            <button class="w-full px-6 py-5 text-left font-semibold text-primary flex justify-between items-center hover:text-accent focus:outline-none transition-colors" onclick="toggleFaq(this)">
              <span>Q. Do you fix dishwasher door latch and leak issues?</span>
              <svg class="w-5 h-5 text-slate-400 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="hidden px-6 pb-5 text-xs md:text-sm text-slate-600 leading-relaxed">
              Yes. Dishwasher leaks can be related to worn door seals, loose connections, hoses, inlet valves, or other components. A door that doesn't latch properly can also prevent the dishwasher from operating correctly. If you're dealing with either problem, our dishwasher repair team in the GTA can identify the source and recommend the appropriate fix.
          ...
          <div class="bg-white border border-bordercolor rounded-xl overflow-hidden shadow-sm">
            <button class="w-full px-6 py-5 text-left font-semibold text-primary flex justify-between items-center hover:text-accent focus:outline-none transition-colors" onclick="toggleFaq(this)">
              <span>Q. How long does a dishwasher repair usually take?</span>
              <svg class="w-5 h-5 text-slate-400 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="hidden px-6 pb-5 text-xs md:text-sm text-slate-600 leading-relaxed">
              The time required depends on the problem and whether a replacement part is needed. Many common issues can be diagnosed quickly, and some repairs can be completed during the first visit when the necessary part is available. Same-day service may be available depending on location and scheduling when you need dishwasher repair in the GTA.
            </div>
          </div>
          ...
          <div class="bg-white border border-bordercolor rounded-xl overflow-hidden shadow-sm">
            <button class="w-full px-6 py-5 text-left font-semibold text-primary flex justify-between items-center hover:text-accent focus:outline-none transition-colors" onclick="toggleFaq(this)">
              <span>Q. Do you service built-in and portable dishwashers?</span>
              <svg class="w-5 h-5 text-slate-400 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="hidden px-6 pb-5 text-xs md:text-sm text-slate-600 leading-relaxed">
              Yes. We service both built-in and portable dishwasher models, including many major brands. Depending on the model, service may include drainage problems, leaks, cleaning performance, door issues, water-filling problems, and other common faults. Our GTA dishwasher repair technicians can assist with a wide range of models.
            </div>
          </div>
        </div>
