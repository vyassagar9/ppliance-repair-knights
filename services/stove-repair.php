...
<?php include __DIR__ . '/../header.php'; ?>
  ...
  <nav class="bg-white border-b border-bordercolor">
    <div class="max-w-7xl mx-auto px-4 py-3 text-xs font-semibold flex items-center gap-2">
      ...
      <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
      <span class="text-primary font-bold">Stove & Range Repair</span>
    </div>
  </nav>
  ...
  <main class="flex-grow">
    ...
    <section class="bg-primary text-white py-12 md:py-16 overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div class="lg:col-span-7 space-y-6">
          <span class="text-accent text-sm md:text-base font-bold uppercase tracking-widest block">Stove Specialists</span>
          <h1 class="text-3xl md:text-5xl font-heading font-bold text-white tracking-tight leading-tight">
            Stove, Range & <br><span class="text-accent">Induction Oven Repair Services</span>
          </h1>
          <p class="text-slate-300 text-base md:text-lg max-w-xl leading-relaxed">
            Is your oven not heating up, cooktop burners sparking but failing to light, or uneven baking ruining meals? We repair gas ranges, induction glass cooktops, and wall-ovens safely and quickly.
          </p>
          <div class="space-y-3">
            <div class="flex items-center gap-2.5 text-slate-200">
              ...
              <span>Common heating elements, igniters, and safety valves in stock</span>
            </div>
            <div class="flex items-center gap-2.5 text-slate-200">
              <svg class="w-4 h-4 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
        ...
        <div class="lg:col-span-5">
          <?php $defaultAppliance = 'Oven & Stove'; include __DIR__ . '/../forms/quote-form.php'; ?>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12">
      <div class="lg:col-span-8 space-y-12">
        <div class="space-y-4">
          <h2 class="text-2xl font-heading font-bold text-primary">Gas & Electric Cooking Appliances Diagnostics</h2>
          <p class="text-slate-600 leading-relaxed text-sm md:text-base">
            Cooking ranges, wall ovens, and glass cooktops draw immense electrical currents or Gas lines. A failing safety valve, burnt element coil, or shorted electronic control panel calls for a licensed gas fitting or professional electrical diagnostic. Our local techs keep TSSA credentials and carry igniters, elements, and switches directly on the dispatch van.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
          <!-- Left: Symptoms -->
          <div class="space-y-6">
            <h3 class="text-xl font-heading font-bold text-primary">Common Stove Problems We Fix</h3>
            <ul class="space-y-3.5">
              <li class="flex items-start gap-2 text-sm text-slate-600">
                <span class="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0"></span>
                <span><strong>Oven Not Heating:</strong> Blown bake element or failing gas burner igniter clicking repeatedly.</span>
              </li>
              <li class="flex items-start gap-2 text-sm text-slate-600">
                <span class="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0"></span>
                <span><strong>Gas Burner Sparks but Won't Ignite:</strong> Spills clogging the burner cap slits, or a failing gas solenoid.</span>
              </li>
              <li class="flex items-start gap-2 text-sm text-slate-600">
                <span class="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0"></span>
                <span><strong>Uneven Baking Temperatures:</strong> Damaged temperature sensor bulb or failed control panel relay.</span>
              </li>
              <li class="flex items-start gap-2 text-sm text-slate-600">
                <span class="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0"></span>
                <span><strong>Touch Controls Dead:</strong> Control board fuses or relays blown from power grid surges.</span>
              </li>
            </ul>
          </div>
          ...
          <div class="space-y-6">
            <h3 class="text-xl font-heading font-bold text-primary">Stove Types We Service</h3>
            <p class="text-sm text-slate-600 leading-relaxed">
              Our technicians carry credentials and tooling to service:
            </p>
            <ul class="space-y-2 text-sm text-slate-700 font-semibold">
              <li class="flex items-center gap-2">
                <span class="w-1.5 h-1.5 rounded-full bg-accent"></span>
                Gas Ranges & Dual-Fuel Ovens (TSSA Certified)
              </li>
              <li class="flex items-center gap-2">
                <span class="w-1.5 h-1.5 rounded-full bg-accent"></span>
                Smooth-Top Glass Induction Cooktops
              </li>
              <li class="flex items-center gap-2">
                <span class="w-1.5 h-1.5 rounded-full bg-accent"></span>
      ...
      <aside class="lg:col-span-4 space-y-8">
        ...
        <div class="bg-white border border-bordercolor rounded-xl p-6 shadow-sm space-y-4">
          <h4 class="font-heading font-bold text-primary text-base border-b border-slate-100 pb-2">Stove & Oven Repair Service Areas</h4>
        ...
        <div class="bg-white border border-bordercolor rounded-xl p-6 shadow-sm space-y-4">
          ...
          <div class="grid grid-cols-3 gap-3 text-center text-[10px] font-bold text-slate-400">
            <span class="p-2 border border-slate-100 rounded">JennAir</span>
