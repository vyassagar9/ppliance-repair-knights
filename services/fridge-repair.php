...
$canonical_url = 'https://www.appliancerepairknights.ca/services/fridge-repair.php';
include '../head.php';
?>
    ...
    <div id="mobile-menu-drawer" class="hidden md:hidden bg-white border-t border-bordercolor shadow-lg transition-all duration-300">
      <div class="px-4 py-4 space-y-3 flex flex-col">
        ...
        <div class="grid grid-cols-2 gap-2 bg-slate-50 p-2.5 rounded-lg border border-bordercolor">
          <a href="fridge-repair.php" class="text-sm font-semibold py-1.5 text-accent cursor-pointer">Fridge</a>
    ...
    <section class="py-16 max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-12">
      <div class="lg:col-span-8 space-y-12">
        ...
        <div class="h-64 md:h-96 bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center border border-bordercolor">
          <img src="../img/fridge-repair.avif" alt="Refrigerator Repair Details" class="object-cover w-full h-full">
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-6 border border-bordercolor bg-white rounded-xl space-y-4 shadow-sm">
          ...
          <p class="text-sm text-slate-600 leading-relaxed italic">
            "My fridge stopped cooling out of nowhere on a Saturday morning. I called their line, had a technician at my house in Mississauga by 1:30 PM, and he replaced a start relay. Saved me $200 in groceries. Excellent service!"
          </p>
          <div class="text-xs font-bold text-primary">
            Marcus K. — Refrigerator Repair, Mississauga
          </div>
        </div>
        ...
        <div class="p-6 border border-bordercolor bg-white rounded-xl space-y-4 shadow-sm">
          ...
          <p class="text-sm text-slate-600 leading-relaxed italic">
            "Prompt, clean, and highly professional service. The ice maker was leaking and they diagnosed and fixed it under 45 minutes. Upfront pricing was exactly as quoted."
          </p>
          <div class="text-xs font-bold text-primary">
            Diana R. — Ice Maker Repair, Toronto
          </div>
        </div>
      </div>
    </section>
