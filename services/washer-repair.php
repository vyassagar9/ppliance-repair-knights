...
$canonical_url = 'https://www.appliancerepairknights.ca/services/washer-repair.php';
include '../head.php';
?>
...
?>
    ...
    <div id="mobile-menu-drawer" class="hidden md:hidden bg-white border-t border-bordercolor shadow-lg transition-all duration-300">
      <div class="px-4 py-4 space-y-3 flex flex-col">
        ...
        <div class="grid grid-cols-2 gap-2 bg-slate-50 p-2.5 rounded-lg border border-bordercolor">
          ...
          <a href="washer-repair.php" class="text-sm font-semibold py-1.5 text-accent cursor-pointer">Washer</a>
  ...
  <nav class="bg-white border-b border-bordercolor">
    <div class="max-w-7xl mx-auto px-4 py-3 text-xs font-semibold flex items-center gap-2">
      ...
      <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
      <span class="text-primary font-bold">Washing Machine Diagnostic & Repair</span>
    </div>
  </nav>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-6 border border-bordercolor bg-white rounded-xl space-y-4 shadow-sm">
          ...
          <p class="text-sm text-slate-600 leading-relaxed italic">
            "Our front-loader washer was leaking from the door seal. They came out same-day, replaced the door boot gasket in 30 minutes, and did a complete diagnostic to make sure nothing else was wrong. Excellent job!"
          </p>
          <div class="text-xs font-bold text-primary">
            Arthur G. — Washer Gasket Repair, Oshawa
          </div>
        </div>
        ...
        <div class="p-6 border border-bordercolor bg-white rounded-xl space-y-4 shadow-sm">
          ...
          <p class="text-sm text-slate-600 leading-relaxed italic">
            "Unbalanced load was shaking our washing machine violently. The technician arrived on-site, replaced the suspension rods, and it runs quietly like new now. Super clean work."
          </p>
          <div class="text-xs font-bold text-primary">
            Jane P. — Washer Suspension Repair, Hamilton
          </div>
        </div>
      </div>
    </section>
