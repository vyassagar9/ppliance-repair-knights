...
<header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-brandBorder shadow-sm">
  <div class="max-w-7xl mx-auto px-4 h-20 flex justify-between items-center">
    ...
    <a href="<?php echo $base_url ? $base_url : './'; ?>" class="flex items-center gap-2 group focus:outline-none flex-shrink-0" aria-label="Appliance Repair Knights Homepage">
      <img src="<?php echo $base_url; ?>img/logo.webp" alt="Appliance Repair Knights Logo" width="220" height="88" fetchpriority="high" style="aspect-ratio: 220 / 88;" class="h-14 sm:h-16 w-auto object-contain transition-transform group-hover:scale-105">
    </a>
